# EASYCARE – Elder Support & Monitoring System

EASYCARE is a mobile application UI/UX prototype designed to support elderly individuals through health monitoring, medication reminders, communication, and emergency assistance. The system connects Elders, Caregivers, and Family Members into a single, easy-to-use care ecosystem that improves safety, coordination, and peace of mind.

This project focuses on accessibility, simplicity, and real-world usability, making it suitable for elderly users with minimal technical familiarity.
...
👉 https://www.figma.com/proto/4tJKPOIkAWcLygeubfEs9t/Untitled?node-id=1-2&p=f&t=8YE2iN1xLVHglfr6-1&scaling=scale-down&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=1%3A2
